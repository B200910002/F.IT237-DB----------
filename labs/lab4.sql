...
alter table ajiltan alter ajiltanregno set default 'noregister';
...
alter table ajiltan alter albantushaal_albantushaalcode set default '--';
...
alter table ajiltan add constraint FK_ajiltanangilal foreign key(angilal_angilalcode) references ajiltanangilal(angilalcode);
alter table ajiltan drop constraint FK_ajiltanangilal;
...
-- lab4
-- -- -- -- -- -- -- update cascade
alter table zahialga drop constraint zahialga_ibfk_1;
alter table zahialga add constraint zahialga_ibfk_1 foreign key(zahialagch_zahialagchid) references zahialagch(zahialagchid) on update cascade;
select * from information_schema.table_constraints where Table_name = 'ajiltan';
update zahialagch set zahialagchid = '1000' where zahialagchner = 'Jamts Budee';
select * from zahialagch;
select * from zahialga;

alter table ajiltan drop constraint ajiltan_ibfk_2;
alter table ajiltan add constraint ajiltan_ibfk_2 foreign key(angilal_angilalcode) references ajiltanangilal(angilalcode) on update cascade;
select * from information_schema.table_constraints where Table_name = 'ajiltan';
update ajiltanangilal set angilalcode = '1000' where angilalcode = 1;
select * from ajiltan;
select * from ajiltanangilal;

-- -- -- -- -- -- -- delete cascade
alter table zahialgiindelgerengui drop constraint zahialgiindelgerengui_ibfk_2;
alter table zahialgiindelgerengui add constraint zahialgiindelgerengui_ibfk_2 foreign key(nom_nomdansno) references nom(nomdansno) on delete cascade;
select * from information_schema.table_constraints where Table_name = 'zahialgiindelgerengui' and CONSTRAINT_SCHEMA = "lib";
delete from nom where nomdansno = 1;
select * from nom;
select * from zahialgiindelgerengui;

alter table hurgelt drop constraint hurgelt_ibfk_1;
alter table hurgelt add constraint hurgelt_ibfk_1 foreign key(ajiltan_ajiltancode) references ajiltan(ajiltancode) on delete cascade;
select * from information_schema.table_constraints where Table_name = 'ajiltan' and CONSTRAINT_SCHEMA = "lib";
delete from ajiltan where ajiltancode = 'em01';
select * from ajiltan;
select * from hurgelt;

-- -- -- -- -- restrict
alter table zahialga drop constraint zahialga_ibfk_1;
alter table zahialga add constraint zahialga_ibfk_1 foreign key(zahialagch_zahialagchid) references zahialagch(zahialagchid) on update restrict;
select * from information_schema.table_constraints where Table_name = 'zahialga' and CONSTRAINT_SCHEMA = "lib";
update zahialagch set zahialagchid = '1' where zahialagchner = 'Jamts Budee';
select * from zahialagch;
select * from zahialga;

alter table ajiltan drop constraint ajiltan_ibfk_2;
alter table ajiltan add constraint ajiltan_ibfk_2 foreign key(angilal_angilalcode) references ajiltanangilal(angilalcode) on update restrict;
select * from information_schema.table_constraints where Table_name = 'ajiltan' and CONSTRAINT_SCHEMA = "lib";
update ajiltanangilal set angilalcode = '100' where angilalner ='admin';
select * from ajiltan;
select * from ajiltanangilal;

alter table zahialgiindelgerengui drop constraint zahialgiindelgerengui_ibfk_2;
alter table zahialgiindelgerengui add constraint zahialgiindelgerengui_ibfk_2 foreign key(nom_nomdansno) references nom(nomdansno) on delete restrict;
select * from information_schema.table_constraints where Table_name = 'zahialgiindelgerengui' and CONSTRAINT_SCHEMA = "lib";
delete from nom where nomdansno = 2;
select * from nom;
select * from zahialgiindelgerengui;

alter table hurgelt drop constraint hurgelt_ibfk_1;
alter table hurgelt add constraint hurgelt_ibfk_1 foreign key(ajiltan_ajiltancode) references ajiltan(ajiltancode) on delete restrict;
select * from information_schema.table_constraints where Table_name = 'ajiltan' and CONSTRAINT_SCHEMA = "lib";
delete from ajiltan where ajiltancode = 'em02';
select * from ajiltan;
select * from hurgelt;

-- -- -- -- -- -- set null
desc zahialga;
alter table zahialga modify column zahialagch_zahialagchid int null;
alter table zahialagch modify column zahialagchid int null; 

alter table zahialga drop constraint zahialga_ibfk_1;
alter table zahialga add constraint zahialga_ibfk_1 foreign key(zahialagch_zahialagchid) references zahialagch(zahialagchid) on update set null;
select * from information_schema.table_constraints where Table_name = 'zahialga' and CONSTRAINT_SCHEMA = "lib";
update zahialagch set zahialagchid = 22 where zahialagchner = 'Jamts Budee';
select * from zahialagch;
select * from zahialga;

desc hurgelt;
alter table hurgelt modify column ajiltan_ajiltancode varchar(4) null;

alter table hurgelt drop constraint hurgelt_ibfk_1;
alter table hurgelt add constraint hurgelt_ibfk_1 foreign key(ajiltan_ajiltancode) references ajiltan(ajiltancode) on delete set null;
select * from information_schema.table_constraints where Table_name = 'ajiltan' and CONSTRAINT_SCHEMA = "lib";
delete from ajiltan where ajiltancode = 'em02';
select * from ajiltan;
select * from hurgelt;
